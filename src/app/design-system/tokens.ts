 ...
 *
 * NOTE: CSS variables in theme.css are the primary token source.
 * This file mirrors them for TypeScript components that need typed access.
 * Do not add new colors here without also adding to theme.css first.
 *
...
export const input = {
  ...
  focus: {
    ...
    ring: `0 0 0 3px ${colors.primary[500]}20`,
  },
} as const;
