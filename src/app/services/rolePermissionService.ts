 ...
 *
 * Manages all dynamic permission operations for the Super Admin.
 * Persists custom role permissions and sub-roles to DataService.
 */
...
class RolePermissionServiceClass {
  ...
  getEffectivePermissions(role: Role, cityId: string): PermissionMatrix {
    ...
    // Fall back to default from permissionMatrix
