...
CONSUMABLE_USAGE["SHINE"]    = CONSUMABLE_USAGE["Water Wash"];
CONSUMABLE_USAGE["PROTECT"]  = CONSUMABLE_USAGE["Shampoo Wash"];
CONSUMABLE_USAGE["ELITE"]    = CONSUMABLE_USAGE["Shampoo+Wax"];
CONSUMABLE_USAGE["ELITE_2W"] = CONSUMABLE_USAGE["Shampoo+Polish"];

CONSUMABLE_USAGE_2W["SHINE"]    = CONSUMABLE_USAGE_2W["Water Wash"];
CONSUMABLE_USAGE_2W["PROTECT"]  = CONSUMABLE_USAGE_2W["Shampoo Wash"];
...
export function getClothCost(planType: string): number {
  ...
  const interiorClothCost = (
    planType === "Shampoo Wash" || planType === "PROTECT" ||
