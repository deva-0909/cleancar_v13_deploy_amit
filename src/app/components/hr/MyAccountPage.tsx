 ...
 *
 * Shows: Profile, Payslip, Leave Balance, Attendance Summary, Mobile Change
 * Replaces the broken direct link to /my-account/mobile-change
 */
...
import {
  ...
  Briefcase, MapPin, Shield, Download, Bell,
} from "lucide-react";
...
export function MyAccountPage() {
  ...
  const handleMobileSubmit = () => {
    ...
    addApproval({
      ...
      description: `Mobile change request\nEmployee: ${emp?.fullName || currentRole}\nCurrent: ${emp?.mobile || "—"}\nNew: ${newMobile}\nReason: ${mobileReason}`,
      priority: "Medium",
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-4 pt-4 border-t">
                <p className="text-xs text-gray-500 mb-3">Recent Leave Applications</p>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg text-sm">
                      ...
                      <Badge className={l.status === "Approved"
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  { month: "April 2026",  gross: 28500, deductions: 3420, net: 25080, status: "Processed" },
                  { month: "March 2026",  gross: 28500, deductions: 3420, net: 25080, status: "Processed" },
                  { month: "February 2026", gross: 28500, deductions: 3420, net: 25080, status: "Processed" },
                  { month: "January 2026",  gross: 28000, deductions: 3360, net: 24640, status: "Processed" },
                ].map((ps, i) => (
                  <div key={i} className="flex items-center justify-between p-4 border rounded-xl hover:bg-gray-50 transition-colors">
                    <div>
                      ...
                      <div className="text-xs text-gray-500 mt-0.5">
                        Gross: ₹{ps.gross.toLocaleString("en-IN")} &nbsp;·&nbsp;
                        Deductions: ₹{ps.deductions.toLocaleString("en-IN")} &nbsp;·&nbsp;
                        <span className="text-green-700 font-medium">Net: ₹{ps.net.toLocaleString("en-IN")}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <Badge className="bg-green-100 text-green-800 border-0 text-xs">{ps.status}</Badge>
              ...
              {mobileSubmitted || existingMobileRequest ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-600 max-w-xs mx-auto">
                    Your mobile number change request is pending approval from HR.
                    You will be notified once it is processed.
                  </p>
                  <Badge className="mt-4 bg-yellow-100 text-yellow-800 border-0">
                    Pending Approval
                  </Badge>
                </div>
              ) : (
                <div className="space-y-5">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <p className="font-semibold text-gray-900 text-lg tracking-widest">
                      {displayMobile}
                    </p>
                  </div>
