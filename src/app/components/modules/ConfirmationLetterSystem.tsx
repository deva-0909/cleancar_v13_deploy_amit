    ...
    <div className="bg-white p-8 border border-gray-300">
      ...
      <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
        ...
        <p>
          ...
          <strong>
            {new Date(
              (record as any).appointmentLetterDate || record.joiningDate
            ).toLocaleDateString("en-IN")}
          </strong>
          {!(record as any).appointmentLetterDate && (
            <span className="text-xs text-gray-400 ml-1">(approx. — appointment letter date not recorded)</span>
          )}.
        </p>
