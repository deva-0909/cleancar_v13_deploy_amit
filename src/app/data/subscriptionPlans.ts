...
// Updated: June 2026 — aligns with SHINE/PROTECT/ELITE plan structure
...
export const ADD_ON_SERVICES: AddOnService[] = [
  ...
  },
  {
    ...
    description: "Shampoo wash + full body panel-by-panel hand wax application. Outer body only — no glass. ELITE subscribers get this included monthly.",
    billing: "Per visit",
  ...
  },
  {
    ...
    billing: "Per visit",
    pricing: { hatchback: 199, suv: 249, luxury: 349, twoW: "NA" },
    bestPairedWith: ["EXPRESS_WASH", "SMART_WASH", "ELITE"],
    estimatedMargin: 78,
    isActive: true,
    icon: "💧",
  ...
  },
  {
    ...
    bestPairedWith: ["SMART_WASH", "ELITE"],
    estimatedMargin: 82,
    isActive: true,
    icon: "⚙️",
    category: "Maintenance",
  },
  {
    id: "addon-007",
    name: "Car Fragrance",
    description: "Interior car fragrance spray — single fresh application. Also included monthly in Smart Wash and ELITE plans.",
    billing: "Per visit",
...
export const UPSELL_SCRIPTS = {
  ...
  protectToWax:   `Shall we do a full hand wax this month? ₹199 for hatchback — your car will look brand new. ELITE subscribers get this free every month — but you can add it once for ₹199.`,
...
export function getAllOneTimeWashOptions(vehicleCategory: string): {
  ...
  return [
    { type: "waterWash",   label: "Water Wash",    price: ONE_TIME_PRICING.waterWash[tier]   },
    { type: "shampooWash", label: "Shampoo Wash",  price: ONE_TIME_PRICING.shampooWash[tier] },
    { type: "shampooWax",  label: "Shampoo + Wax", price: ONE_TIME_PRICING.shampooWax[tier]  },
  ];
}
...
export function getPricingSummary(vehicleCategory: string, planType: string) {
  ...
  return {
    ...
    planName: PLAN_TIER_NAMES[planType] || planType,
    vehicleCategory,
  };
}
